...
const Register = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-950 via-blue-950 to-gray-950 flex items-center justify-center p-4">
      <Helmet>
        <title>Sign Up - NovaVid</title>
        <meta name="description" content="Create your NovaVid account and start your 5-day free trial with 100 credits." />
      </Helmet>
      ...
      >
        <div className="bg-gray-900/50 backdrop-blur border border-gray-800 rounded-2xl p-8 shadow-2xl">
          ...
          <p className="text-gray-400 text-center mb-8">Start your 5-day free trial with 100 credits</p>
